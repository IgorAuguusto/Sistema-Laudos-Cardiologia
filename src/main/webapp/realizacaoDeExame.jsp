						...
						<tr>
							...
							<td>
								<form method="post" action="Controller">
									...
									<input type="hidden" name="tipoExame"
										value="${exame.tipoExame}" /> <input type="hidden"
										name="examePacienteCpf" value="${exame.pacienteCpf}" /> <input
										type="submit" value="Realizar Exame" />
								</form>
							</td>
						</tr>
					</c:forEach>
